...
//        control.add(new ImageObject(screenWidth/3, (int)(screenHeight*0.8), "blue.png"));
//        // moving objects (enemy)
//        for(int i=0; i<10; i++)
//            moving.add(new ImageObject((int)(Math.random() * screenWidth), -1 * (int)(Math.random() * screenHeight), "knife.png"));
//        // constants objects (gold)
//        for(int i=0; i<5; i++)
//            constant.add(new ImageObject((int)(screenWidth*0.9*Math.random()), (int)(screenHeight*0.9*Math.random()), "heart.png"));
//    }
